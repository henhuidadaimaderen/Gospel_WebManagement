  ...
  <div>
    ...
    <div style="height: 60px; line-height: 60px; background-color: white; margin-bottom: 2px; display:flex">
      <div style="width: 300px">
        ...
        <span style="margin-left: 25px; font-size: 24px">Gospel后台管理系统</span>
      </div>
      ...
      <div
        ...
        <el-menu :default-active="$route.path"
          ...
          <el-submenu index="admin">
            ...
            <el-menu-item index="/addAdmin">学生账号添加</el-menu-item>
            <el-menu-item index="/adminList">学生账号列表</el-menu-item>
          </el-submenu>
          <el-submenu index="select">
            ...
            <el-menu-item index="/classes">选课情况</el-menu-item>
            <el-menu-item index="/sc">课程设置</el-menu-item>
          </el-submenu>
        </el-menu>
      </div>
